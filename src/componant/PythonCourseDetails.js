...
const PythonCourseDetails = () => {
  ...
  function movetoCreatejop(e) {
    e.preventDefault();
    navigate("/PythonCourseLayout"); // Navigate to the JobForm page
  }
  return (
    <div>
      <BarStudent/>
    ...
    <div className="container mt-5 mb-3 ">
      <div className="row">
              ...
              <div className="accordion-item w-100 mb-2">
                ...
                >
                  <div className="accordion-body">
                    <p>
                      In this lesson, you will learn about the origins of
                      Python, its key features, and why it is such a popular
                      language among developers.
                    </p>
                    <div className="d-flex mt-4">
                      <button className="btn-gold ms-auto ">
                        WATCH LECTURE
                      </button>
                    </div>
                  </div>
        ...
        <div className="col-12 col-md-5 col-lg-4 ps-md-5 ">
          ...
          <button
            className="bg-grey w-100 text-uppercase  rounded mb-3 mb-lg-4  ButtonsTable  mt-3 mt-lg-3"

          ...
          <div className="profile-header">
            <div className="profile-content">
              ...
              <div className="profile-edit">
                <button className="btn btn-warning" onClick={movetoProfile}>
                  SAVE CHANGES
                </button>
              </div>
            </div>
                ...
                <div className="info-section">
                  ...
                  <ul className="info-list-bottom">
                    <li>
                      ...
                      <input
                        type="text"
                        placeholder="balqeessaber@gmail.com"
                        className="edit-botton-data"
                      />
                    </li>
                    <li>

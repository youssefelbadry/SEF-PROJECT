...
function Addarticle() {
       ...
       <div className="container   mt-5 ">
        <div className=' pt-5 mt-5 pb-2'>
                <h4 className='textGray cap txt'>Create New Artical</h4>
                 ...
                 <p className='txt'>6th June 2023</p>
        </div>
        <div className="row">
        <div className="col-lg-3 col-md-12">
            ...
            <div className=' p-4 pb-2  row '>
                <div className=' p-2 col-lg-9 col-md-12'>
                    ...
                    <div className="line2  mb-2 " >
                    </div>
                </div>
               <div className="col-lg-3  col-md-12 d-none d-md-block">
               <button className="form-control btn btn1 ms-2  px-2 py-1"  type="submit">
                        <a className="nav-link text-white " href="#">publish</a>
                </button>
               </div>
    ...
    <div className="row">
      <div className="col-lg-7 col-md-12">
        <div className="input1">
          <label htmlFor="textInput" className="form-label cap capli fs-6">Article Title</label>
          <input
            type="text"
  ...
  <div className="mb-3 d-block d-md-flex justify-content-end my-3">
    <button type="button" className="btn col-md-2 col-12 ms-1 btn-secondary  text-white py-2 px-2" style={{ fontWeight: "500" }}>CANCEL</button>
    <button type="submit" style={{ fontWeight: "500" }} className="btn mt-2 col-md-2 col-12 btn1 ms-1 text-white py-2 px-2">SAVE</button>
  </div>
</form>
       ...
       <div className="container   mt-5 ">
        ...
        <div className="row">
            <div className="col-lg-4">
                <div className="asideList  bg-container">
                     <AsideList/>
                </div>

  ...
  return (
    <div className="container">
      ...
      {detailscodes.map((course, index) => (
        <div className='col-12 mt-3 RegisterdcoursecardInstructor' key={index}>
          <div className='p-3'>
            ...
            <div className='row align-items-center pt-3 justify-content-between'>
              ...
              <div className='col-4 d-flex align-items-center'>
                <i className="far fa-user px-2" style={{ color: '#FFD43B' }}></i>
      ...
      <div className='row'>
        ...
        <button className="btn btn-warning col-4 d-none d-md-block">
          Create New
        </button>
      </div>
      <div className='row'>
        {detailscodeexam.map((course, index) => (
          <div className='col-md-12 d-flex my-2' key={index}>
            <div className='col-3 d-flex flex-column align-items-center p-3' style={{ color: 'white', backgroundColor: 'black' }}>
            ...
            <div className='col-9 p-0'>
              <div className='p-3 RegisterdcoursecardInstructor'>
                <div className='row'>
                  ...
                  <i className="fas fa-edit col-1" style={{ color: '#FFD43B' }}></i>
                </div>
                <h5>

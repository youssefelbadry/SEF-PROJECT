...
function Infocoursesusers() {
  return (
    ...
    <HeaderPages/>
      ...
      <div className="container mt-4 p-3 d-none d-md-block  text-white rounded" style={{zIndex:'2' , position:'relative'}}>
      <div className="d-flex justify-content-between" style={{zIndex:'2' , position:'relative'}}>
        <span>LEVEL : 1</span>
        <span>97%</span>
      </div>
      <div className="progress my-3" style={{zIndex:'2' , position:'relative' , height:'5px'}}>
        <div
      ...
      <div className="d-flex align-items-center" style={{zIndex:'2' , position:'relative' ,fontSize:'1.5rem'}}>
